...
public class HDLegacyHologram implements io.github.projectunified.unihologram.api.Hologram<Location>, PlayerVisibility {
    ...
    private HologramLine fromHDLine(com.gmail.filoghost.holographicdisplays.api.line.HologramLine hdLine) {
        if (hdLine instanceof ItemLine) {
            ...
            String text = ((TextLine) hdLine).getText();
            if (text == null) {
                text = "";
            }
    ...
    public void setLines(@NotNull List<HologramLine> lines) {
        ...
        for (HologramLine line : lines) {
            if (line instanceof ItemHologramLine) {
                ...
                hologram.appendTextLine(((TextHologramLine) line).getColoredContent());
            } else {
    ...
    public void insertLine(int index, @NotNull HologramLine line) {
        ...
        if (line instanceof ItemHologramLine) {
            ...
            hologram.insertTextLine(index, ((TextHologramLine) line).getColoredContent());
        } else {
